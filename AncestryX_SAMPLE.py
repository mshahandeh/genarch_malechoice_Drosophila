...
#these are the ends of the parents SNP files
...
#X      28      6       0       0       5       0       0       0       C
#X      29      6       6       0       0       0       0       0       A
#X      30      6       6       0       0       0       0       0       A

#inf = open("/Users/michaelshahandeh/Documents/Sequencing/BCsynA_scripts/X_Analysis/parents.X_SNPs.txt", "r")
#inf2 = open("/Users/michaelshahandeh/Documents/Sequencing/BCsynA_scripts/X_Analysis/1.X_SNP.txt", "r")

inf = open("/home/mshahandeh/BCsynA/sim_bcfs/simC4_synA.X_SNPs.txt","r") 
inf2 = open("/home/mshahandeh/BCsynA/sim_bams/sim_pileups/SAMPLE.X_SNP.txt","r")    

#output will be the % synA ancestry, so 0 = simC4, 1 = synA, options in between

outf = open("/home/mshahandeh/BCsynA/Ancestry/X/ancestry_SAMPLE_X.txt","w")    
#outf = open("/Users/michaelshahandeh/Desktop/Ancestry_1X.txt","w") 
#outf2 = open("/Users/michaelshahandeh/Desktop/rawdata_1X.txt" , "w")
outf2 = open("/home/mshahandeh/BCsynA/Ancestry/X/raw/rawdata_SAMPLE_X.txt" , "w")

outf.write('SAMPLE' + '\n')
outf2.write('SAMPLE' + '\n')
 
# ---------------------------------------------------------------------------------------------------
 #first: read in a list of marker states and positions (snps different between parents in my case)
positions = []
simC4 = []
synA = []
...
while done < 1: # this kicks in when you are out of markers
    ...
    if end > lenx:  ########################################################  #THIS IS JENKY: I have to manually input these values at the top
        done = 1
